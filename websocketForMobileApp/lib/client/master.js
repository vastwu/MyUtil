...
socketImplement.$onReady(function(err, socket){
    ...
    //var SERVER_OPERATE_DOMAIN = 'http://' + location.hostname + ':8888';
    var SERVER_OPERATE_DOMAIN = '';

    var startServer = function(cb){
        var s = document.createElement('script');
        s.src = SERVER_OPERATE_DOMAIN + '/?qt=start&cb=window.$$startFinish';
        window.$$startFinish = cb;
        document.body.appendChild(s);
    }
    var stopServer = function(cb){
        var s = document.createElement('script');
        s.src = SERVER_OPERATE_DOMAIN + '/?qt=stop&cb=window.$$stopFinish';
